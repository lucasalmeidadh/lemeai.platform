...
const Sidebar: FC<SidebarProps> = () => {
    ...
    const isAdmin = permissions.includes('gbcode_admin_sistema');
    ...
    const isGestaoActive = ['/users', '/equipes', '/metas', '/profiles'].includes(location.pathname);
    ...
    return (
        <aside className="sidebar" ref={settingsRef}>
            ...
            <nav className="sidebar-nav">
                ...
                {(can('gestao_usuarios') || can('gestao_perfis') || can('gestao_equipes') || can('gestao_metas') || can('regras_chatbot') || can('gestao_produtos') || can('gestao_conexoes') || can('dias_funcionamento') || can('gestao_empresas') || can('gerenciar_planos')) && (
                <div className="sidebar-group">
                    <div className="sidebar-group-title">Administração</div>

                    {/* Gestão */}
                    {(can('gestao_usuarios') || can('gestao_perfis') || can('gestao_equipes') || can('gestao_metas')) && (
                    <div className="sidebar-item-wrapper">
                        <button
