...
interface AgendaInternaTabProps {
    googleConectado: boolean;
    onAfterGoogleSync?: () => void;
}

const AgendaInternaTab: React.FC<AgendaInternaTabProps> = ({ googleConectado, onAfterGoogleSync }) => {
    ...
    const handleSincronizar = async () => {
        if (!googleConectado) {
            toast.error("Conecte sua conta Google na aba Google Calendar para sincronizar.");
            return;
        }
        setIsSyncing(true);
        try {
            ...
            <div className="agenda-tab-header">
                ...
                <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                    <button
                        ...
                        disabled={isSyncing || !googleConectado}
                        title={googleConectado ? "Reconciliar com o Google Calendar" : "Conecte o Google Calendar para sincronizar"}
                    >
...
export default AgendaInternaTab;
